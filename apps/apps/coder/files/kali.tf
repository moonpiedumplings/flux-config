# This is a coder template that creates a Kali Linux image, with a selkies web based UI. 
...
resource "coder_agent" "main" {
  ...
  metadata {
    ...
    key          = "3_home_disk"
    script       = "coder stat disk --path /config"
    interval     = 60
    timeout      = 1
  }
  ...
  spec {
    ...
    template {
      ...
      spec {
        ...
        container {
          name              = "main"
          image             = "docker.io/linuxserver/kali-linux:1655de8c-ls73"
